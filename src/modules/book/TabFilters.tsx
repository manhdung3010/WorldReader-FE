...
//
const TabFilters = ({ setFormFilter }: any) => {
  const [isOpenMoreFilter, setisOpenMoreFilter] = useState(false);
  const [dataCategory, setDataCategory] = useState([]);
  const [isDiscount, setIsDiscount] = useState(false);
  const [rangePrices, setRangePrices] = useState([1, 10000000]);
  ...
  const applyCategories = (close: () => void) => {
  ...
  const clearCategories = (close: () => void) => {
    setCategoriesState([]);
    setFormFilter((prev: any) => ({
      ...prev,
      categories: null,
  ...
  const applyPriceRange = (close: () => void) => {
    setFormFilter((prev: any) => ({
      ...prev,
  ...
  const clearPriceRange = (close: () => void) => {
      ...
      <Popover className="relative">
        {({ open, close }) => (
          <>
            ...
            >
              <Popover.Panel className="absolute z-40 w-screen max-w-[1200px] px-4 mt-3 left-0 sm:px-0">
                <div className="overflow-hidden rounded-2xl shadow-xl bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-700">
                            ...
                            <div className="ml-4 space-y-3">
                              {item.children.map((child: any) => (
                                <Checkbox
                                  ...
                                  onChange={(checked) =>
                                    handleChangeCategories(checked, child.id)
                                  }
                                />
                              ))}
                            </div>
                  ...
                  <div className="p-5 bg-neutral-50 dark:bg-neutral-900 dark:border-t dark:border-neutral-800 flex items-center justify-between">
                    <ButtonThird
                      onClick={() => clearCategories(close)}
                      sizeClass="px-4 py-2 sm:px-5"
                    >
                      Clear
                    </ButtonThird>
                    <ButtonPrimary
                      onClick={() => applyCategories(close)}
                      sizeClass="px-4 py-2 sm:px-5"
                    >
                      Apply
                    </ButtonPrimary>
          ...
          <>
            ...
            >
              ...
              rangePrices[1] !== PRICE_RANGE[1] ? (
                <span onClick={() => clearPriceRange(close)}>
                  {renderXClear()}
                </span>
              ) : null}
            </Popover.Button>
                    ...
                    <div className="px-6 sm:px-8 md:px-10 divide-y divide-neutral-200 dark:divide-neutral-800">
                      ...
                      <div className="py-7">
                        ...
                        <div className="mt-6 relative ">
                          {renderMoreFilterItem(dataCategory)}
                        </div>
                      </div>
                      {/* ---- */}
                      <div className="py-7">
